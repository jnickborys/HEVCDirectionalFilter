...
static const int INIT_PRED_I[1][2][10][2] =
{
  //----- model 0 -----
  {
...
static const int INIT_PRED_P[3][3][11][2] =
{
  //----- model 0 -----
  {
    {  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED },
...
#ifdef MB32X32
static const int INIT_MAP_I[1][NUM_BLOCK_TYPES-2][15][2] =
#else
static const int INIT_MAP_I[1][9][15][2] =
#endif
#else
...
#ifdef USE_INTRA_MDDT
#ifdef MB32X32
static const int INIT_MAP_P[3][NUM_BLOCK_TYPES-2][15][2] =
#else
static const int INIT_MAP_P[3][9][15][2] =
#endif
#else
...
#ifdef USE_INTRA_MDDT
#ifdef MB32X32
static const int INIT_LAST_I[1][NUM_BLOCK_TYPES-2][15][2] =
#else
static const int INIT_LAST_I[1][9][15][2] =
#endif
#else
...
#ifdef USE_INTRA_MDDT
#ifdef MB32X32
static const int INIT_LAST_P[3][NUM_BLOCK_TYPES-2][15][2] =
#else
static const int INIT_LAST_P[3][9][15][2] =
#endif
#else
...
#ifdef MB32X32
static const int INIT_ONE_I[1][NUM_BLOCK_TYPES-3][5][2] =
#else
...
#ifdef MB32X32
static const int INIT_ONE_P[3][NUM_BLOCK_TYPES-3][5][2] =
#else
...
#ifdef MB32X32
static const int INIT_ABS_I[1][NUM_BLOCK_TYPES-3][5][2] =
#else
...
#ifdef MB32X32
static const int INIT_ABS_P[3][NUM_BLOCK_TYPES-3][5][2] =
#else
...
static const int INIT_MODULATED_QUANTIZATION_I[1][1][2][2]=
{
  //----- model 0 -----
  {
    { { 13,  41} , {   3,  62} }
...
static const int INIT_MODULATED_QUANTIZATION_P[3][1][2][2]=
{
  //----- model 0 -----
  {
    { { 13,  41} , {   3,  62} }
...
static const int INIT_BCBP_FD_SD_I[1][1][4][2] =
{
  //----- model 0 -----
  {
    {  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED }
...
static const int INIT_BCBP_FD_SD_P[3][1][4][2] =
{
  //----- model 0 -----
  {
    { {  -15,  58} , {  -9,  65} , { -10,  64} , {  -4,   66} }
  },
  //----- model 1 -----
  {
    { { -2 , 60 } , { -2 , 85 } , { 2 , 77 } , { -13 , 112 } }
  },
  //----- model 2 -----
  {
    { {  -15,  58} , {  -9,  65} , { -10,  64} , {  -4,   66} }
...
static const int INIT_BCBP_FD_SD8_I[1][1][4][2] =
{
  //----- model 0 -----
  {
    {  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED }
...
static const int INIT_BCBP_FD_SD8_P[3][1][4][2] =
{
  //----- model 0 -----
  {
    { {   -8,  35} , { -27,  80} , { -26,  76} , { -58, 138} }
  },
  //----- model 1 -----
  {
    { { 1 , 42 } , { -4 , 79 } , { -6 , 75 } , { -35 , 103 } }
  },
  //----- model 2 -----
  {
    { {   -8,  35} , { -27,  80} , { -26,  76} , { -58, 138} }
...
static const int INIT_MAP_SD_I[1][1][15][2] =
{
  //----- model 0 -----
  {
    {  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED,  CTX_UNUSED,  CTX_UNUSED,  CTX_UNUSED,  CTX_UNUSED,  CTX_UNUSED,  CTX_UNUSED,  CTX_UNUSED,  CTX_UNUSED,  CTX_UNUSED,  CTX_UNUSED,  CTX_UNUSED }
...
static const int INIT_MAP_SD_P[3][1][15][2] =
{
  //----- model 0 -----
  {
    { {  -39, 121} , { -37, 116} , { -36, 112} , { -34, 108}, { -33, 105} , { -31, 102} , { -30,  99}, { -27,  96}, { -24,  91}, { -21,  87}, { -19,  85}, { -16,  83}, { -14,  83}, { -10,  83}, {  -5,  90} }
  },
  //----- model 1 -----
  {
    { { -16 , 80 } , { -15 , 76 } , { -15 , 72 } , { -14 , 70 } , { -12 , 66 } , { -12 , 65 } , { -11 , 63 } , { -10 , 60 } , { -8 , 57 } , { -7 , 57 } , { -5 , 57 } , { -4 , 57 } , { -4 , 60 } , { -3 , 66 } , { -2 , 80 } }
  },
  //----- model 2 -----
  {
    { {  -39, 121} , { -37, 116} , { -36, 112} , { -34, 108}, { -33, 105} , { -31, 102} , { -30,  99}, { -27,  96}, { -24,  91}, { -21,  87}, { -19,  85}, { -16,  83}, { -14,  83}, { -10,  83}, {  -5,  90} }
...
static const int INIT_LAST_SD_I[1][1][15][2] =
{
  //----- model 0 -----
  {
    {  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED,  CTX_UNUSED,  CTX_UNUSED,  CTX_UNUSED,  CTX_UNUSED,  CTX_UNUSED,  CTX_UNUSED,  CTX_UNUSED,  CTX_UNUSED,  CTX_UNUSED,  CTX_UNUSED,  CTX_UNUSED }
...
static const int INIT_LAST_SD_P[3][1][15][2] =
{
  //----- model 0 -----
  {
    { { 36 , -48 } , { 31 , -38 } , { 32 , -38 } , { 36 , -42 } , { 30 , -35 } , { 29 , -33 } , { 30 , -33 } , { 29 , -31 } , { 29 , -31 } , { 29 , -27 } , { 28 , -23 } , { 28 , -18 } , { 25 , -7 } , { 20 , 14 } , { 14 , 48 } }
  },
  //----- model 1 -----
  {
    { { 5 , 3 } , { 10 , -3 } , { 12 , -5 } , { 15 , -7 } , { 13 , -6 } , { 13 , -6 } , { 14 , -4 } , { 14 , -2 } , { 15 , -2 } , { 15 , 1 } , { 15 , 6 } , { 18 , 10 } , { 13 , 25 } , { 11 , 43 } , { 6 , 74 } }
  },
  //----- model 2 -----
  {
    { { 36 , -48 } , { 31 , -38 } , { 32 , -38 } , { 36 , -42 } , { 30 , -35 } , { 29 , -33 } , { 30 , -33 } , { 29 , -31 } , { 29 , -31 } , { 29 , -27 } , { 28 , -23 } , { 28 , -18 } , { 25 , -7 } , { 20 , 14 } , { 14 , 48 } }
...
static const int INIT_ONE_SD_I[1][1][5][2] =
{
  //----- model 0 -----
  {
    {  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED,  CTX_UNUSED }
...
static const int INIT_ONE_SD_P[3][1][5][2] =
{
  //----- model 0 -----
  {
    { { -5 , 63 } , { -9 , 30 } , { -6 , 22 } , { -5 , 20 } , { -4 , 23 } }
  },
  //----- model 1 -----
  {
    { { 11 , 34 } , { 25 , -20 } , { 13 , -7 } , { 5 , 3 } , { 9 , 1 } } 
  },
  //----- model 2 -----
  {
    { { -5 , 63 } , { -9 , 30 } , { -6 , 22 } , { -5 , 20 } , { -4 , 23 } }
...
static const int INIT_ABS_SD_I[1][1][5][2] =
{
  //----- model 0 -----
  {
    {  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED,  CTX_UNUSED }
...
static const int INIT_ABS_SD_P[3][1][5][2] =
{
  //----- model 0 -----
  {
    { { -8 , 60 } , { -10 , 75 } , { -15 , 90 } , { -20 , 102 } , { -31 , 125 } }
  },
  //----- model 1 -----
  {
    { { -3 , 47 } ,  { -7 , 67 } , { -9 , 80 } , { -9 , 87 } , { -29 , 120 } }
  },
  //----- model 2 -----
  {
    { { -8 , 60 } , { -10 , 75 } , { -15 , 90 } , { -20 , 102 } , { -31 , 125 } }
...
static const int INIT_MB_ADAP_I[1][1][4][2] =
{
  //----- model 0 -----
  {
    {  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED}
...
static const int INIT_MB_ADAP_P[3][1][4][2] =
{
  //----- model 0 -----
  {
    { { -4 , 86 } , { -1 , 83 } , { -1 , 82 } , { -1 , 83 } }
...
static const int INIT_MAP8_SD_I[1][1][63][2] =
{
  //----- model 0 -----
  {
    {  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,
       CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,
       CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,
       CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,
       CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,
...
static const int INIT_MAP8_SD_P[3][1][63][2] =
{
  //----- model 0 -----
  {
    { { -22 , 80 } , { -20 , 74 } , { -21 , 73 } , { -19 , 69 } , { -20 , 69 } , { -20 , 68 } ,
      { -19 , 66 } , { -18 , 63 } , { -19 , 63 } , { -18 , 60 } , { -19 , 60 } , { -19 , 59 } ,
      { -18 , 57 } , { -17 , 55 } , { -17 , 54 } , { -15 , 50 } , { -15 , 50 } , { -16 , 50 } ,
      { -15 , 49 } , { -15 , 48 } , { -15 , 47 } , { -15 , 47 } , { -15 , 46 } , { -13 , 43 } ,
      { -13 , 42 } , { -14 , 44 } , { -14 , 43 } , { -13 , 41 } , { -14 , 42 } , { -13 , 41 } ,
      { -13 , 40 } , { -12 , 40 } , { -13 , 40 } , { -12 , 39 } , { -12 , 38 } , { -12 , 39 } ,
      { -11 , 37 } , { -10 , 35 } , { -10 , 36 } , { -10 , 35 } , { -11 , 36 } , { -11 , 37 } ,
      { -10 , 35 } , {  -8 , 33 } , { -10 , 34 } , { -10 , 35 } , { -10 , 35 } , {  -9 , 34 } ,
      {  -8 , 32 } , { -10 , 36 } , {  -9 , 35 } , {  -8 , 34 } , {  -9 , 35 } , {  -7 , 34 } ,
      {  -9 , 37 } , {  -7 , 34 } , {  -9 , 41 } , {  -8 , 39 } , {  -9 , 45 } , {  -7 , 45 } ,
      {  -5 , 47 } , {  -6 , 59 } , {  -3 , 71 } }
  },
  //----- model 1 -----
  {
    { { -8 , 61 } ,  { -7 , 56 } , { -11 , 59 } , { -11 , 57 } , { -11 , 55 } , { -15 , 60 } ,
      { -12 , 53 } , { -13 , 54 } ,{ -15 , 56 } , { -12 , 51 } , { -13 , 50 } , { -15 , 52 } ,
      { -12 , 48 } , { -10 , 43 } , { -12 , 45 } , { -11 , 42 } , { -12 , 44 } , { -10 , 41 } ,
      { -10 , 39 } , { -11 , 39 } , { -10 , 39 } , { -10 , 38 } , { -10 , 37 } , { -11 , 39 } ,
      { -9 , 35 } , { -10 , 36 } , { -9 , 33 } , { -8 , 32 } , { -10 , 35 } , { -7 , 30 } ,
      { -9 , 33 } , { -9 , 33 } , { -9 , 32 } , { -8 , 31 } , { -8 , 31 } , { -7 , 29 } ,
      { -8 , 31 } , { -8 , 30 } , { -8 , 29 } , { -7 , 29 } , { -8 , 29 } , { -8 , 29 } ,
      { -8 , 29 } , { -5 , 25 } , { -7 , 28 } , { -8 , 29 } , { -6 , 28 } , { -5 , 27 } ,
      { -6 , 27 } , { -5 , 27 } , { -3 , 24 } , { -2 , 23 } , { -5 , 28 } , { -3 , 24 } ,
      { -7 , 33 } , { -4 , 29 } , { -4 , 31 } , { -5 , 33 } , { -3 , 32 } , { -3 , 38 } ,
      { -1 , 40 } , { 7 , 36 } ,  { -6 , 76 }
    }
  },
  //----- model 2 -----
...
static const int INIT_LAST8_SD_I[1][1][63][2] =
{
  //----- model 0 -----
  {
    {  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,  CTX_UNUSED ,
...
static const int INIT_LAST8_SD_P[3][1][63][2] =
{
  //----- model 0 -----
  {
    { { -2 ,   4 } , {  1 ,   1 } , {  2 ,  2 } , {  4 , -2 } , {  4 ,   0 } , {  3 ,   2 } , {  6 ,  -1 } ,
      {  7 ,  -1 } , {  6 ,  -1 } , {  9 , -4 } , {  9 , -3 } , {  9 ,  -4 } , {  9 ,  -3 } , {  9 ,  -2 } ,
      { 12 ,  -7 } , { 12 ,  -5 } , { 10 , -3 } , { 11 , -6 } , { 12 ,  -5 } , { 13 ,  -7 } , { 12 ,  -5 } ,
      { 13 ,  -7 } , { 15 ,  -9 } , { 13 , -6 } , { 14 , -6 } , { 16 , -10 } , { 15 ,  -7 } , { 14 ,  -6 } ,
      { 15 ,  -7 } , { 19 , -12 } , { 17 , -9 } , { 15 , -6 } , { 16 ,  -7 } , { 17 ,  -9 } , { 17 ,  -7 } ,
      { 21 , -14 } , { 16 ,  -6 } , { 18 , -7 } , { 17 , -5 } , { 17 ,  -5 } , { 18 ,  -7 } , { 22 , -10 } ,
      { 19 ,  -5 } , { 18 ,  -4 } , { 26 ,-13 } , { 19 , -2 } , { 21 ,  -4 } , { 26 , -11 } , { 20 ,   1 } ,
      { 29 , -12 } , { 25 ,  -3 } , { 29 , -6 } , { 33 ,-10 } , { 33 ,  -7 } , { 31 ,  -1 } , { 29 ,   6 } ,
      { 32 ,   5 } , { 35 ,   6 } , { 33 , 13 } , { 30 , 26 } , { 23 ,  46 } , { 21 ,  59 } , { 11 ,  89 }
    }
  },
  //----- model 1 -----
  {
    { { 2 , 2 } , { 7 , -1 } , { 9 , -3 } , { 12 , -7 } , { 24 , -23 } , { 13 , -6 } , { 23 , -19 } ,
      { 14 , -4 } , { 31 , -31 } , { 23 , -18 } , { 15 , -6 } , { 15 , -7 } , { 22 , -17 } , { 31 , -30 } ,
      { 24 , -19 } , { 11 , 1 } , { 21 , -14 } , { 18 , -9 } , { 28 , -25 } , { 20 , -12 } , { 13 , 0 } ,
      { 26 , -20 } , { 18 , -7 } , { 23 , -16 } , { 28 , -22 } , { 19 , -9 } , { 25 , -18 } , { 32 , -28 } ,
      { 18 , -7 } , { 28 , -22 } , { 29 , -22 } , { 31 , -24 } , { 19 , -6 } , { 26 , -16 } , { 23 , -10 } ,
      { 25 , -12 } , { 29 , -20 } , { 26 , -13 } , { 37 , -29 } , { 23 , -6 } , { 29 , -16 } , { 17 , 3 } ,
      { 11 , 14 } , { 39 , -25 } , { 35 , -21 } , { 23 , 0 } , { 17 , 10 } , { 25 , -2 } , { 27 , -3 } ,
      { 27 , 2 } , { 32 , -6 } , { 38 , -11 } , { 18 , 21 } , { 25 , 15 } , { 25 , 17 } , { 22 , 28 } ,
      { 13 , 44 } , { 18 , 41 } , { 23 , 38 } , { 27 , 44 } , { 28 , 49 } , { 11 , 84 } , { -6 , 118 }
    }
  },
  //----- model 2 -----
  {
...
static const int INIT_ALF_BLK_FLAG_I[1][1][3][2] = 
{
  //----- model 0 -----
  {
    {  {  31,  21} , {  31,  31} , {  25,  50} },
...
static const int INIT_ALF_BLK_FLAG_P[3][1][3][2] = 
{
  //----- model 0 -----
  {
    {  {  12,  40} , {  11,  51} , {  14,  59} },
