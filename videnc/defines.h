...
// Mode dependent Directional transform for intra coding
#define USE_INTRA_MDDT      
// use high precision interpolation and prediction (including bidirectional prediction rounding)
#define USE_HP_FILTER

#ifdef USE_HP_FILTER
// Switched filters with offsets
...
#define RDO_Q
#ifdef RDO_Q
#define RDO_Q_BUG_FIX
#endif
// New offset for wetihed prediction
#define USE_NEW_OFFSET

// Bug fix in JM11.0
#define BUG_FIX_FOR_FREXT

//VCEG-AJ25 Simplified RD Picture Decision
#define SIMPLIFIED_RDPIC_DECISION
...
#define SQR_DEPTH(org,rec,depth,increase) ((increase)? img->quad[Clip3(0,((1<<(depth))-1),((org)+(1<<(increase-1)))>>increase)-Clip3(0,((1<<(depth))-1),((rec)+(1<<(increase-1)))>>increase)] : img->quad[(org)-(rec)])
#endif
