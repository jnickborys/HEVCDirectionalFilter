...
Mapping Map[] = {
...
#ifdef MB32X32
  {"InterSearchSkip",          &configinput.InterSearchSkip,              0,   1.0,                       1,  0.0,              1.0              },
#endif
...
#ifdef EAIF
  {"UseAdaptiveFilter",        &configinput.UseAdaptiveFilter,            0,   0.0,                       1,  0.0,              5.0              },
#else
  ...
  {"UseHPFilter",              &configinput.UseHPFilter,                  0,   0.0,                       1,  0.0,              4.0              },
#else
  ...
  {"UseAdaptiveLoopFilter",    &configinput.UseAdaptiveLoopFilter,        0,   0.0,                       1,  0.0,              1.0              },
#ifdef ALF_SPATIAL_PREDICT_COEF
  {"ALFPredCoefMode",          &configinput.ALFPredCoefMode,              0,   0.0,                       1,  0.0,              1.0              },
#endif
#endif
#ifdef SIMPLIFIED_RDPIC_DECISION
  {"SimplifiedRDPicDecision",  &configinput.SimplifiedRDPicDecision,      0,   0.0,                       1,  0.0,              1.0              },
#endif
#ifdef MB32X32
  {"UseExtMB",                  &configinput.UseExtMB,                    0,   0.0,                       1,  0.0,              2.0              },
#endif
