...
extern CSptr cs_spatial_domain_coding;
extern CSptr cs_spatial_domain_coding_rd_opt;
extern CSptr cs_slice_coding;
extern CSptr cs_slice_coding1;
#endif

extern CSptr cs_mb, cs_b8, cs_cm, cs_imb, cs_ib8, cs_ib4, cs_pc;
extern imgpel   mpr_8x8ts[16][16];
#ifdef MB32X32
extern imgpel   rec_mbY[16<<MAX_MB_EXT_LEVEL][16<<MAX_MB_EXT_LEVEL], rec_mbU[16<<MAX_MB_EXT_LEVEL][16<<MAX_MB_EXT_LEVEL], rec_mbV[16<<MAX_MB_EXT_LEVEL][16<<MAX_MB_EXT_LEVEL];    // reconstruction values
#else
...
extern void   set_stored_macroblock_parameters1 (void);
...
#ifdef RDO_Q
extern void   set_stored_macroblock_parameters_intra (int);
extern void   store_macroblock_parameters_intra (int);
