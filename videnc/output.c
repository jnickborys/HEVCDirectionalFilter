...
#ifdef  INTERNAL_BIT_DEPTH_INCREASE
    img2buf (p->imgUV[1], buf, p->size_x_cr, p->size_y_cr, symbol_size_in_bytes, crop_left, crop_right, crop_top, crop_bottom, input->InputBitDepth, img->BitDepthIncreaseChroma);
#else
...
#ifdef  INTERNAL_BIT_DEPTH_INCREASE
  img2buf (p->imgY, buf, p->size_x, p->size_y, symbol_size_in_bytes, crop_left, crop_right, crop_top, crop_bottom, input->InputBitDepth, img->BitDepthIncrease);
#else
...
#ifdef  INTERNAL_BIT_DEPTH_INCREASE
    img2buf (p->imgUV[0], buf, p->size_x_cr, p->size_y_cr, symbol_size_in_bytes, crop_left, crop_right, crop_top, crop_bottom, input->InputBitDepth, img->BitDepthIncreaseChroma);
#else
