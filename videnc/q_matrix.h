...
extern int *****LevelScale4x4Luma_IAQMS;        // For I,P,B-slice
extern int ******LevelScale4x4Chroma_IAQMS;     // For I,P,B-slice
extern int *****LevelScale8x8Luma_IAQMS;        // For I,P,B-slice

extern int *****InvLevelScale4x4Luma_IAQMS;     // For I,P,B-slice
extern int ******InvLevelScale4x4Chroma_IAQMS;  // For I,P,B-slice
extern int *****InvLevelScale8x8Luma_IAQMS;     // For I,P,B-slice

extern short ScalingList4x4_IAQMS[NUM_OF_IAQMS_MAT][6][16];
extern short ScalingList8x8_IAQMS[NUM_OF_IAQMS_MAT][2][64];
#endif
